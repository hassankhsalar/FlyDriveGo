...
const TourDetails = () => {
  ...
  if (!tour) {
    return (
      <p className="text-center text-lg font-semibold mt-10">Tour not found.</p>
    );
  }
  ...
  return (
    <div className="max-w-6xl mx-auto bg-white font-red-rose px-2 sm:px-4">
      ...
      <div className="relative">
        ...
        <div className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center text-center px-4 py-6">
          ...
          <p className="text-lg sm:text-xl md:text-2xl font-semibold text-[#4EDAE4] mt-2">
            {tour.price.currency} {tour.price.per_person.toLocaleString()} / per
            person
          </p>
        </div>
      </div>
      ...
      <div className="sticky top-0 bg-white shadow-md z-10">
        <ul className="flex flex-wrap justify-center gap-1 sm:gap-2 md:space-x-4 lg:space-x-6 bg-white border-b border-gray-200 py-2 sm:py-3">
          {[
            ...
            <li
              key={tab}
              className={`px-2 sm:px-3 md:px-4 lg:px-6 py-1 sm:py-2 text-xs sm:text-sm md:text-base lg:text-lg font-semibold cursor-pointer transition-all duration-300 ${
                activeTab === tab
      ...
      <div className="mt-4 sm:mt-6 md:mt-8 px-2 sm:px-4 md:px-6 py-4 sm:py-6">
        ...
        {activeTab === "information" && (
          <div>
            ...
            <p className="text-red-600 text-xs sm:text-sm font-extralight">
              Been there recently?
            </p>
            ...
            <div className="bg-[#4EDAE4] p-2 sm:p-3 md:p-4 flex flex-wrap justify-around gap-2 sm:gap-3 md:gap-4 mt-3 sm:mt-4 rounded-lg">
              <div className="flex flex-col items-center">
                ...
                <p className="mt-1 text-black text-xs sm:text-sm md:text-base font-medium">
                  {tour.duration}
                </p>
              </div>
              <div className="flex flex-col items-center">
            ...
            <div className="max-w-4xl mx-auto p-3 sm:p-4 md:p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 border-t border-gray-300">
                {/* Destination */}
                <div className="border-b border-gray-300 py-2 sm:py-3 text-sm sm:text-base font-semibold">
                  Destination
                </div>
              ...
              {tour.accommodation && (
                <div className="mt-6 sm:mt-8">
                  <h3 className="text-lg sm:text-xl md:text-2xl font-semibold text-[#4EDAE4] mb-3 sm:mb-4 md:mb-6 border-b pb-1 sm:pb-2">
                    Accommodation
                  </h3>
                  ...
                  <div className="bg-white p-3 sm:p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between mb-2 sm:mb-3 md:mb-4">
                      ...
                      <div className="flex items-center mt-1 sm:mt-0">
                        <span className="text-gray-700 text-xs sm:text-sm font-medium mr-1 sm:mr-2">
                          Rating:
                        </span>
                        <div className="flex">
                          {[...Array(5)].map((_, i) => (
                            <svg
                              ...
                              className={`w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5 ${
                                i < Math.floor(tour.accommodation.rating)
                                  ? "text-yellow-400"
                                  : "text-gray-300"
                              }`}
                              fill="currentColor"
                    ...
                    {tour.accommodation.photos &&
                      tour.accommodation.photos.length > 0 && (
                        <div>
                          <h5 className="font-medium text-gray-700 text-xs sm:text-sm mb-2 sm:mb-3">
                            Hotel Photos:
                          </h5>
              ...
              <div className="relative border-l border-gray-300">
                {tour.itinerary.map((plan, index) => (
                  <div key={index} className="mb-4 sm:mb-6 md:mb-8">
                    <div className="absolute w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5 bg-[#4EDAE4] z-10 border-2 sm:border-3 md:border-4 border-white rounded-full left-[0px] transform -translate-x-1/2 -translate-y-1/2" />
            ...
            <div className="bg-white p-4 sm:p-5 md:p-6 rounded-lg shadow-md">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
                ...
                <div className="border border-gray-200 rounded-lg p-3 sm:p-4 hover:shadow-md transition-shadow">
                  <h4 className="font-bold text-[#4EDAE4] text-base sm:text-lg mb-2 sm:mb-3">
                    Breakfast
                  </h4>
                  <p className="text-gray-600 text-sm sm:text-base mb-2 sm:mb-3">
                    <span className="font-medium">Time:</span>{" "}
                    {tour.food.meal_schedule.breakfast.time}
                  </p>
                  <div>
                    ...
                    <ul className="space-y-1 sm:space-y-2">
                      {tour.food.meal_schedule.breakfast.options.map(
                        (option, index) => (
                          <li
                            key={index}
                ...
                <div className="border border-gray-200 rounded-lg p-3 sm:p-4 hover:shadow-md transition-shadow">
                  ...
                  <p className="text-gray-600 text-sm sm:text-base mb-2 sm:mb-3">
                    <span className="font-medium">Time:</span>{" "}
                    {tour.food.meal_schedule.lunch.time}
                  </p>
                  <div>
                    <p className="font-medium text-sm sm:text-base mb-1 sm:mb-2">
                      Options:
                    ...
                    <ul className="space-y-1 sm:space-y-2">
                      {tour.food.meal_schedule.lunch.options.map(
                        (option, index) => (
                          <li
                            key={index}
                            className="flex items-center gap-2 text-xs sm:text-sm"
                ...
                <div className="border border-gray-200 rounded-lg p-3 sm:p-4 hover:shadow-md transition-shadow">
                  ...
                  <p className="text-gray-600 text-sm sm:text-base mb-2 sm:mb-3">
                    <span className="font-medium">Time:</span>{" "}
                    {tour.food.meal_schedule.dinner.time}
                  </p>
                  <div>
                    <p className="font-medium text-sm sm:text-base mb-1 sm:mb-2">
                      Options:
                    ...
                    <ul className="space-y-1 sm:space-y-2">
                      {tour.food.meal_schedule.dinner.options.map(
                        (option, index) => (
                          <li
                            key={index}
                            className="flex items-center gap-2 text-xs sm:text-sm"
              ...
              <div className="mt-6 sm:mt-8 bg-blue-50 p-3 sm:p-4 md:p-5 rounded-lg border border-blue-100">
                ...
                <p className="text-blue-700 text-xs sm:text-sm">
                  Please inform us in advance about any specific dietary
                  requirements or allergies. We'll do our best to accommodate
                  your needs while ensuring you experience authentic local
                  cuisine.
                </p>
              </div>
            </div>
      ...
      <div className="text-center my-4 sm:my-6 md:my-8">
        <Link to="/tour-booking" state={{ tour }}>
