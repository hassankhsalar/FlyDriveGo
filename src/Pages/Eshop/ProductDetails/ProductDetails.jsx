        ...
        axiosSecure.post('/carts', cartItem)
            .then(res => {
                if (res.data.insertedId) {
                    ...
                    Swal.fire({
                        icon: 'success',
                        title:'Thanks for adding to cart',
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12">
                        ...
                        <div className="flex justify-center sm:justify-start gap-2 mt-4 overflow-x-auto pb-2 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent">
                            {product.photo.map((img, index) => (
                                <button
                                    ...
                                    className={`flex-shrink-0 bg-gray-50 w-16 h-16 sm:w-20 sm:h-20 rounded-md overflow-hidden transition-all duration-200 ${currentImageIndex === index
                ...
                <div className="flex flex-col">
                    ...
                    <div className="flex flex-col xs:flex-row gap-3 mt-4 sm:mt-auto">
                        <button
                            onClick={addToCart}
                            className="grow py-3 px-4 sm:px-6 bg-[#0FABCA] hover:bg-[#0D96B3] transition-colors duration-200 rounded-md text-white font-medium shadow-sm text-center">
                            Add To Cart
                        </button>
